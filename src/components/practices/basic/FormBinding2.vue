...
<template>
  <div class="practice-section">
    ...
    <section style="margin-bottom: 20px">
      ...
      <input type="text" v-model.number="age" placeholder="입력.나이." />
      <p>
    ...
    <section>
      ...
      <input type="text" v-model.trim="userEmail" placeholder="앞뒤 공백을 포함해 입력 ㄱㄱ" />
      <p>
    ...
    <section>
      ...
      <input type="text" v-model.trim.number="price" placeholder="공백과 숫자 입력..." />
      <p>
